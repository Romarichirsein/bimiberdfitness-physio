...
const WhatsAppButton = () => {
    return (
        <a 
            ...
            className="fixed bottom-6 right-6 sm:bottom-8 sm:right-8 z-[60] bg-[#25D366] p-3 sm:p-4 rounded-full shadow-2xl hover:scale-110 transition-transform active:scale-95"
